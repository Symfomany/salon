...
<html lang="{{ config('app.locale') }}">
  ...
  <div class="row">
    ...
    <div id="test2" class="col s12">
        <div id="app">
            <div class="row" v-for="(item, index) in 30">
                <div class="col s6">
                ...
                <div class="col s3">
                    <p>
                        <input type="checkbox" v-bind:id="index + 1" />
                        <label v-bind:for="index">Beta @{{ index + 1 }}</label>
                    </p>

                     <p>
                        <input type="checkbox" v-bind:id="index + 2" />
                        <label v-bind:for="index">Beta @{{ index + 2 }}</label>
                    </p>
                </div>
            </div>
        </div>
