          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Salon ORCAB Du 15/16/17 MARS 2017 autour de plus de 52 Coopératives ORCAB</p>
              </div>
              <div class="col l4 offset-l2 s12">
                <h5 class="white-text">Plus de 52 Coopératives ORCAB</h5>
                <ul>
                  <li><a class="grey-text text-lighten-3" href="#!">Coopérative 1</a></li>
                  <li><a class="grey-text text-lighten-3" href="#!">Coopérative 2</a></li>
                  <li><a class="grey-text text-lighten-3" href="#!">Coopérative 3</a></li>
                  <li><a class="grey-text text-lighten-3" href="#!">Coopérative 4</a></li>
                </ul>
              </div>
            </div>
          </div>
