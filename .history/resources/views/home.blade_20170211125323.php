        ...
        <form action="{{ route('register')}}" method="post">
            ...
            <div id="one" class="col s12">
                <div  class="row">
                        ...
                        <div class=" animated fadeIn input-field col s12 m6 l6">
                            ...
                            <input autocomplete="off" name="cooperative" placeholder="Format: 552 100 554" pattern="^(RCS )?([0-9]{3} ){2}[0-9]{3}$|^([0-9]{3} ){3}[0-9]{4}$" required id="siren" type="text" class="validate">
            ...
            <div id="two" class="col s12">
                        ...
                        <div class="row naviguations center-align">
                            <button disabled class="btn waves-effect waves-light" id="moins"><i class="material-icons">keyboard_arrow_left</i> Précédent</button>
                            <button class="btn waves-effect waves-light" id="plus"><i class="material-icons">keyboard_arrow_right</i> Suivant</button>
                        </div>
