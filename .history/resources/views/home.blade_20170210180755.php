...
<html lang="{{ config('app.locale') }}">
  ...
  <div class="row ">
    ...
    <div id="one" class="col s12">
        <form>
                <div class="animated fadeInDown input-field col l6 m6 s12" data-wow-delay="0.01s">
                    <i class="material-icons prefix">account_circle</i>
                    <input pattern=".{2,}" required id="lastname" name="lastname" type="text" class="validate">
                    <label for="lastname">Nom</label>
                </div>

                <div data-wow-delay="0.02s" class="wow animated fadeInDown input-field col s12 m6 l12">
                    <i class="material-icons prefix">account_circle</i>
                    <input pattern=".{2,}" required id="firstname" namd="firstname" type="text" class="validate">
                    <label for="firstname">Prénom</label>
                </div>

                <div data-wow-delay="0.03s" class="wow animated fadeInDown input-field col s12 m6 l12">
                    <i class="material-icons prefix">home</i>
                    <input pattern=".{2,}" required name="compagny" id="compagny" type="text" class="validate">
                    <label for="compagny">Entreprise</label>
                </div>

                 <div data-wow-delay="0.04s" class="wow animated fadeInDown input-field col s12 m6 l12">
                ...
                <div data-wow-delay="0.05s" class="wow animated fadeInDown input-field col s12 m6 l12">
                <i class="material-icons prefix">perm_identity</i>
                    <input pattern=".{2,}" required id="fonction" type="text" class="validate">
                    <label for="fonction">Fonction</label>
                </div>

                <div data-wow-delay="0.06s" class="wow animated fadeInDown input-field col s12 m6 l12">
                    <i class="material-icons prefix">email</i>
                    <input  required id="email" type="email" class="validate">
                    <label for="email">Email</label>
                </div>

                 <div data-wow-delay="0.07s" class="wow animated fadeInDown input-field col s12 m6 l12">
                ...
                <div data-wow-delay="0.08s" class="wow animated fadeInDown input-field col s12 m6 l12">
    ...
    <div id="two" class="col s12">
            ...
            <div id="app">
                ...
                <div class="row naviguations">
                    <a class="waves-effect waves-light btn-large"><i class="material-icons">keyboard_arrow_left</i> Précédent</a>
                    <a class="waves-effect waves-light btn-large"><i class="material-icons">keyboard_arrow_right</i> Suivant</a>
                </div>
