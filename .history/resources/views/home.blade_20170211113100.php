  ...
  <div class="row ">
    ...
    <div id="two" class="col s12">
                ...
                <div class="row naviguations">
                    <button class="waves-effect waves-light btn-large plus"><i class="material-icons">keyboard_arrow_left</i> Précédent</button>
                    <button class="waves-effect waves-light btn-large moins"><i class="material-icons">keyboard_arrow_right</i> Suivant</button>
                </div>
...
$(function() {
  ...
  $('div#two').on('change', ':checkbox.discover', function(){
    ...
    var nb = 0;
    $('.naviguations button').click(function(){
