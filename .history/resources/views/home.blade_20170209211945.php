  ...
  <div class="row">
    <div class="col s12">
      <ul class="tabs">
        ...
        <li class="tab col s4"><a href="#test2">Recapitulatif</a></li>
      </ul>
    </div>
    ...
    <div id="test2" class="col s12">
        ...
        <div class="col s4">
            <p>IDENTIFICATIONACCORDSRÉCAPITULATIFCoopérative  COBABSUIVANTRETOURFournitures de bureau et mobilier de bureau</p>
        </div> 
        <div class="col s4">
            <div class="switch">
                <label>
