            ...
            @if(!empty($item) && $loop->index != 0)
                <div class="row feature">
                    ...
                    <div class="col  l4 m4 s12">
                        ...
                        <div class="switch hide-on-med-and-up">
                            <label>
                    ...
                    <div class="col  l4 m4 s12 hide-on-med-and-up">
                        <div class="center-align">
                            <input name="accords[{{ $item }}]" value="member" class="already" value="ok" type="checkbox" id="{{ $item.$loop->index +1000 }}" />
                            <label for="{{ $item.$loop->index + 1000 }}">Deja inscrit</label>
                        </div>
                    </div>
