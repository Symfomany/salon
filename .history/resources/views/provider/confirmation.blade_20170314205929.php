                                 ...
                                 @foreach($liste as $item)
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
                                        <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;">
                                         ...
                                         @if($item['contactname'] != "NA") {{ $item['contactname'] }}  
                                         @endif
                                          
                                          @if($item['contactemail'] != "NA") 
                                           <a href="mailto:{{ $item['contactemail'] }}">{{ $item['contactemail'] }}</a> 
                                          @endif
                                          
                                          @if($item['contactphonenumber'] != "NA") au 
                                          <a href="callto:{{ $item['contactphonenumber'] }}">{{ $item['contactphonenumber'] }}</a>
                                          @endif

                                          @if($item['contactfax'] != "NA") par FAX au {{ $item['contactfax'] }} @endif
                                         
                                         @if($item['contact1email'] != "NA") par E-Mail : 
                                          <a>{{ $item['contact1email'] }}</a> @endif
