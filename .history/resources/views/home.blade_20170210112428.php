        ...
        <form>
                ...
                <div class="input-field col s6">
                 ...
                 <div class="input-field col s6">
                    ...
                    <input pattern="^(RCS )?([0-9]{3} ){2}[0-9]{3}$|^([0-9]{3} ){3}[0-9]{4}$" required id="last_name" type="text" class="validate">
                ...
                <div class="input-field col s6">
                    ...
                    <input data-error="Mauvais Email"  required id="email" type="email" class="validate">
                    <label for="email">Email</label>
                </div>

                 <div class="input-field col s6">
                    <i class="material-icons prefix">phone</i>
                    <input pattern="(0|\\+33|0033)[1-9][0-9]{8}" required name="text" id="phone" type="text" class="validate">
                    <label for="phone">Téléphone</label>
                </div>

                <div class="input-field col s6">
                    <i class="material-icons prefix">card_travel</i>
                    <input pattern=".{2,}" required type="text" id="autocomplete-input" class="autocomplete">
