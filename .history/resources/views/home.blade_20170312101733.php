...
{{-- 
  ...
  <div class="row">
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s4 disabled"><a href="#one">Identification</a></li>
        <li class="tab col s4"><a class="active"  href="#two">Accords</a></li>
    ...
    <div class="card-panel  lighten-2">
        ...
        <div id="three" class="col s12 center-align animated zoomInUp">
            ...
            <a href="{{ route('home') }}" class="btn btn-primary">Revenir au début</a>
        </div>
