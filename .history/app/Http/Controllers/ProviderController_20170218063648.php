...
{   
    ...
    */
    ...
    public function excel(){
        ...
        $csv->insertOne(['Nom','Prenom','Email','Siret','Compagny','Fonction','Telephone','Coopérative','Accords','Date de création']);
        $csv->insertOne();
        $csv->insertOne();
        $csv->insertOne();
        $csv->insertOne();
        $csv->insertOne('Compagny');
        $csv->insertOne('Fonction');
        $csv->insertOne('Telephone');
        $csv->insertOne('Coopérative');
        $csv->insertOne('Accords');
        $csv->insertOne('Date de création');
