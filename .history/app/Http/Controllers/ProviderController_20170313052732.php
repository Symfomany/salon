    ...
    public function fournisseurs(){
        ...
        if(!empty($tab)){
            ...
            foreach($resultat->get() as $sheet){
                dump($tab[strtoupper($sheet['BUREAU VERITAS'])]);
    ...
    */
    public function register(Request $request){
        ...
        Mail::send('provider.confirmation', [
            ...
            $m->from('orcab@pmecentrale.fr', 'PME CENTRALE');
            $m->to($register->email, $register->lastname)->subject('Votre visite au salon ORCAB');
        });
