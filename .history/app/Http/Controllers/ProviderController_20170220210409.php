...
{   
    ...
    */
    public function import(){
        $files = File::allFiles(assets("excels"));
        $tab = [];
    ...
    */
    public function getAccordOne($id){
        ...
        $resultat = Excel::load(public_path("excels/{$id}.xlsx"), function($reader){});
    ...
    */
    public function getOne($id){
        ...
        $resultat = Excel::load(assets("excels/{$id}.xlsx"), function($reader){})->all();

        File::put(assets("export/{$id}.json"), $resultat);
    ...
    */
     public function getAll(){
        ...
        $files = File::allFiles(public_path("import"));

        foreach($files as $file){
            $resultat = Excel::load(public_path("excels/{$file->getFilename()}"), function($reader){})->all();
            $id =  explode(".", $file->getFilename());
