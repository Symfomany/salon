       ...
       //$sheet =  $reader->first();
        foreach($resultat->get() as $sheet){
            ...
            foreach($sheet as $key => $row){
                  ...
                  if(!empty($row)){
                      dump($key);
                      if($key == "[SERVICE GÉNÉRAUX]"){
                          $resultatOne[] = $row;
                      }else if($key == "[MAINTENANCE ET ENTRETIEN DES LOCAUX]"){
                          $resultatTwo = $row;
                      }else if($key == "[FINANCES & SOCIAL]"){
                          $resultatThree = $row;
                      }else if($key == "[CONSOMMABLES]"){
                          $resultatFour = $row;
                      }else if($key == "[VÉHICULES]"){
                          $resultatFive = $row;
                      }
                  }
        ...
        exit(dump($resultatOne, $resultatTwo, $resultatThree,  $resultatFour, $resultatFive));
