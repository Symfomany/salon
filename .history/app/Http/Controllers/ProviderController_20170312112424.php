    ...
    */
    public function getAccordOne($id){
       ...
       $compteur = 0; 
        ...
        $resultatOne = $resultat[0]->toArray();
        $resultatTwo = $resultat[1]->toArray();
        $resultatThree = $resultat[2]->toArray();
        $resultatFour = $resultat[3]->toArray();
        $resultatFive = $resultat[4]->toArray();
