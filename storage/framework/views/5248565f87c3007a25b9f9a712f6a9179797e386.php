...
<html lang="fr">
    ...
    <div class="row" id="logos">
        ...
        <div class="col l3 m4 offset-l6 offset-m4  s12">
            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('img/pme.png')); ?>" class="logo responsive-img" /></a>
        </div>
    </div>
  ...
  <div class="row">
    ...
    <p><small style="font-size: 0.6rem;float:right">Built on version 1.6.1</small></p>
</div>
